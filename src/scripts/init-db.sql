...
CREATE TABLE IF NOT EXISTS analysis_history (
    ...
    sentinel_request_id VARCHAR(255),
...
INSERT INTO vegetation_analysis (field_id, analysis_date, ndvi_value, evi_value, ndwi_value, savi_value, stress_level, health_score, analysis_metadata, cloud_coverage) VALUES
(1, CURRENT_DATE - INTERVAL '7 days', 0.75, 0.68, 0.15, 0.72, 'Good', 78, '{"data_source": "Sentinel-2", "processing_level": "L2A"}', 12.5),
(1, CURRENT_DATE - INTERVAL '14 days', 0.72, 0.65, 0.18, 0.69, 'Good', 75, '{"data_source": "Sentinel-2", "processing_level": "L2A"}', 8.3),
(2, CURRENT_DATE - INTERVAL '5 days', 0.68, 0.61, 0.12, 0.65, 'Fair', 68, '{"data_source": "Sentinel-2", "processing_level": "L2A"}', 15.2),
(3, CURRENT_DATE - INTERVAL '3 days', 0.82, 0.76, 0.22, 0.78, 'Excellent', 85, '{"data_source": "Sentinel-2", "processing_level": "L2A"}', 5.1);
...
-- Grant permissions
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO agrisat_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO agrisat_user;
